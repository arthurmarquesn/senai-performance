...
/**
 * Implementação compartilhada entre:
 *
 * - código server-side do Next.js;
 * - scripts CLI executados com tsx.
 *
 * IMPORTANTE:
 * componentes da aplicação NÃO devem importar este arquivo diretamente.
 * Na aplicação, use "./repository", que possui a barreira "server-only".
 */
